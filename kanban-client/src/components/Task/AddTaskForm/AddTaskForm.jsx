			...
			<form className={formClasses.form}>
				{displayPage1 && (
					<fieldset>
						...
						<div className={formClasses.form__group + " " + classes.subtasks__container}>
							...
							<button className="btn btn-primary btn-sm btn-lg">Add more subtasks</button>
						</div>
					</fieldset>
				)}
				...
				{displayPage2 && (
					<fieldset>
						...
						<button className="btn btn-primary btn-sm btn-lg">Create task</button>
					</fieldset>
				)}

				<div className={classes.pagination}>
					<button
						className={classes.btn__pagination + " " + (displayPage1 ? classes.btn__active : "")}
						onClick={onClickPage1}>
						1
					</button>
					<button
						className={classes.btn__pagination + " " + (displayPage2 ? classes.btn__active : "")}
